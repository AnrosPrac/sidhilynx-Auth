...
# Add to email_services.py (after send_password_reset_otp)

def send_registration_otp(email: str, otp: str, username: str):
    """Send OTP for registration verification"""
    subject = "Verify your SidhiLynx account"
    ...
    <tr>
      <td align="center">
        <table width="520" style="background:#111;border-radius:14px;padding:36px;">
          ...
          <tr>
            <td style="text-align:center;">
              <h2 style="color:#fff;margin-bottom:12px;">Welcome to SidhiLynx, {username}!</h2>
              <p style="font-size:14px;color:#cbd5f5;">
